    ...
    <div class="wrap">
                    ...
                    <div class="shopp_list">
                        ...
                        <div class="list">
                            ...
                            <div class="list_center">
                                ...
                                <div class="info_spec">
                                    <h6 class="spec">規格 </h6>
                                    <div class="colour"> 接PHP</div>
                                </div>
                                <div class="info_price">
                                    <h6 class="price">單價 </h6>
                                    <h6 class="p_rice">NT$ 接PHP</h6>
                                    <div class="counter">
                                        <img src="./img/minus.svg" alt=""> 1 <img src="./img/plus.svg" alt="">
                                    </div>
                                </div>
                                <div class="remove">
                                    <img src="./img/saved.svg" alt=""> 移回喜愛清單
                                </div>
                            </div>
                ...
                <div class="r_part">
                    <div class="amount">
                        ...
                        <div class="amount_footer">
                            <h6>商品總計</h>
                                <h5 class="total_amount">NT$ 22,222</h5>
                        </div>
        ...
        <div class="mobile">
            ...
            <footer>
                ...
                <button class="go_credit"><a href="">前往結帳</a></button>
            </footer>
        </div>
        <div class="full">
            <div class="del_alert">
